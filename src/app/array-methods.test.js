...
test('wordsToCharList', () => {
  ...
  const arr = 'Gregor';
  const actual = wordsToCharList(arr);
...
// test('listFoods', () => {
//   const expected = ['Gruffalo', 'oats', 'brown sugar', 'flour', 'pure maple syrup', 'chopped nuts', 'baking soda', 'baking powder', 'cinnamon', 'melted butter', 'fresh water'];
//   const actual = listFoods(gruffaloCrumble);
